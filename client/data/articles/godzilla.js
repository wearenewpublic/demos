export const godzilla_article = {
    ...
    date: 'April 1, 2023',
    rawText: `
New York, NY — In a turn of events that seems straight out of a science fiction blockbuster, Manhattan finds itself plunged into a state of fear and chaos as a colossal, radioactive lizard rampages through the city streets. The sudden appearance of this massive creature has left residents and authorities alike in a state of disbelief, as the iconic skyline of New York City becomes the backdrop for an unprecedented disaster.
...
export const godzilla_conversation_post_comments = [
    {from: 'b', replyTo: 'fault', text: 'Only members can see this comment'},
